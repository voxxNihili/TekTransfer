...
function Lovely() {
    useEffect(() => {
        ...
        canvas.draw = function () {
            ...
            c.currentFps =
                c.currentFps > c.createItemEvery * c.totalFps
                    ? 0
                    : c.currentFps;
                    ...
                    for (var j = 0; j < c.DATA[0].length; j++) {
                        c.DATA[r + 1][1].push(
                            c.group.createItem(
                                c.DATA[0][j],
                                [
                                    c.DATA[0][j][0] + c.group.width,
                                    c.DATA[0][j][1] + c.group.height,
                                ],
                                r + 1
                            )
                        );
                ...
                for (var m = 0; m < c.DATA[0].length; m++) {
                    c.DATA[r + 1][1].push(
                        t.createItem(
                            c.DATA[0][m],
                            [
                                c.DATA[0][m][0] + t.width,
                                c.DATA[0][m][1] + t.height,
                            ],
                            r + 1
                        )
                    );
        ...
        (canvas.Group.prototype.createItem = function (top, bot, r) {
            ...
            return [
                c.randomMinMax(bot[0], top[0]),
                c.randomMinMax(bot[1], top[1]),
            ];
                                ...
                                c.ctx.lineTo(
                                    ...
                                    group[1][k][1] +
                                        y *
                                            ...
                                            (group[0].acceleration + 1) -
                                        group[0].width
                                ); // continue horizontally (left or right)
                                c.ctx.lineTo(
                                    group[1][k][0] +
                                        x *
                                            group[0].x1 *
            ...
            (canvas.Group.prototype.appearSquirt = function (current, r) {
                ...
                if (
                    c.DATA[r][0].x1 > c.DATA[r][0].stepLength ||
                    c.DATA[r][0].x1 < -c.DATA[r][0].stepLength ||
                    c.DATA[r][0].y1 === 0 ||
                    c.DATA[r][0].x1 === 0
                ) {
                ...
                t.counterCount +=
                    Math.round((1 / c.totalFrameForALoop) * 100) / 100;
                c.DATA[r][0].acceleration =
                    Math.round(Math.abs(Math.sin(t.counter1 / 2)) * 100) / 100;
                c.DATA[r][0].opacityCurve =
                    Math.round(Math.abs(Math.sin(t.counter1)) * 10) / 10;
